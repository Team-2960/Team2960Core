 ...
 * @author GRIP
 */
public class ColorDetectPipeline {
	...
	public class Color {
		 ...
		 */
		public Color(double hueMin, double hueMax, double satMin, double satMax, double lumMin, double limMax) {
			this.hue = new double[] {hueMin, hueMax};
			this.sat = new double[] {satMin, satMax};
			this.lum = new double[] {lumMin, limMax};
		}
	}

	public final Color green = new Color(71.2, 114.0, 36.7, 255.0, 0.0, 255.0);
	public final Color red = new Color(71.2, 114.0, 36.7, 255.0, 0.0, 255.0);
	public final Color yellow = new Color(71.2, 114.0, 36.7, 255.0, 0.0, 255.0);

	/**
	 * This is the primary method that runs the entire pipeline and updates the
	 * outputs.
	 */
	public void process(Mat source0, Color color) {
		// Step Blur0:
		...
		hslThreshold(hslThresholdInput, color.hue, color.sat, color.lum, hslThresholdOutput);
