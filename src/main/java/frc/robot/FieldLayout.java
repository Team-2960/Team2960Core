...
public class FieldLayout {
    ...
    public static final Map<Pose2d, Map<ReefBranchOffset, Pose2d>> bReefPoseSets = Map.of(
            ...
            bReef120, Map.of(
                    ReefBranchOffset.LEFT, bBranchE,
                    ReefBranchOffset.MIDDLE, bReef120,
                    ReefBranchOffset.RIGHT, bBranchF),
            bReef180, Map.of(
                    ReefBranchOffset.LEFT, bBranchG,
                    ReefBranchOffset.MIDDLE, bReef180,
                    ReefBranchOffset.RIGHT, bBranchH),
            bReef240, Map.of(
                    ReefBranchOffset.LEFT, bBranchI,
                    ReefBranchOffset.MIDDLE, bReef240,
                    ReefBranchOffset.RIGHT, bBranchJ),
            bReef300, Map.of(
    ...
    public static final Map<Pose2d, Map<ReefBranchOffset, Pose2d>> rReefPoseSets = Map.of(
            ...
            rReef120, Map.of(
                    ReefBranchOffset.LEFT, rBranchE,
                    ReefBranchOffset.MIDDLE, rReef120,
                    ReefBranchOffset.RIGHT, rBranchF),
            rReef180, Map.of(
                    ReefBranchOffset.LEFT, rBranchG,
                    ReefBranchOffset.MIDDLE, rReef180,
                    ReefBranchOffset.RIGHT, rBranchH),
            rReef240, Map.of(
                    ReefBranchOffset.LEFT, rBranchI,
                    ReefBranchOffset.MIDDLE, rReef240,
                    ReefBranchOffset.RIGHT, rBranchJ),
            rReef300, Map.of(
