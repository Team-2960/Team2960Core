...
public class AngularSparkFlexMech extends AngularMotorMech {
    ...
    public AngularSparkFlexMech(AngularSparkMechConfig config, MotorConfig motorConfig) {
        ...
        switch (config.posEncoderSource) {
            ...
            case ABSOLUTE:
                ...
                break;
            case ALT_EXT:
                flexConfig.externalEncoder.positionConversionFactor(config.posEncoderGearRatio);
                break;
        }
        ...
        switch (config.velEncoderSource) {
            case INTERNAL:
                ...
                break;
            case ALT_EXT:
                flexConfig.externalEncoder.positionConversionFactor(config.posEncoderGearRatio / 60);
                break;
        }
